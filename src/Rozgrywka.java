		...
		for (int i = 0; i < serwer.wysokoscMapy; i++) {
			for (int j = 0; j < serwer.szerokoscMapy; j++) {
				...
				if (serwer.mapa[i][j].charAt(0) != '0') {
					if(serwer.mapa[i][j].charAt(1)=='w'&&serwer.mapa[i][j].charAt(2)=='w'||serwer.mapa[i][j].charAt(1)=='s'&&serwer.mapa[i][j].charAt(2)=='s')
						sciezka+="pws";
					else if(serwer.mapa[i][j].charAt(1)=='a'&&serwer.mapa[i][j].charAt(2)=='a'||serwer.mapa[i][j].charAt(1)=='d'&&serwer.mapa[i][j].charAt(2)=='d')
						sciezka+="pad";
					else if(serwer.mapa[i][j].charAt(1)=='s'&&serwer.mapa[i][j].charAt(2)=='a'||serwer.mapa[i][j].charAt(1)=='d'&&serwer.mapa[i][j].charAt(2)=='w')
						sciezka+="swa";
					else if(serwer.mapa[i][j].charAt(1)=='s'&&serwer.mapa[i][j].charAt(2)=='d'||serwer.mapa[i][j].charAt(1)=='a'&&serwer.mapa[i][j].charAt(2)=='w')
						sciezka+="swd";
					else if(serwer.mapa[i][j].charAt(1)=='d'&&serwer.mapa[i][j].charAt(2)=='s'||serwer.mapa[i][j].charAt(1)=='w'&&serwer.mapa[i][j].charAt(2)=='a')
						sciezka+="ssa";
					else if(serwer.mapa[i][j].charAt(1)=='w'&&serwer.mapa[i][j].charAt(2)=='d'||serwer.mapa[i][j].charAt(1)=='a'&&serwer.mapa[i][j].charAt(2)=='s')
						sciezka+="ssd";
				...
				sciezka+=".png";
				new ImageIcon(sciezka).paintIcon(this, g2d, (int) (94 / (skalaSzerokoscMapa) + j * 200), (int) (77 / (skalaWysokoscMapa) + i * 200));
				}
		}
	}
