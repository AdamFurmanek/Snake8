...
public class Okno extends JFrame {
	...
	public Okno() {
		...
		rozgrywka = new Rozgrywka(szerokoscMapy, wysokoscMapy, 8, 7, 15, 500, 10, false, kolory, pseudonimy, false, false, mapa); // 1
																										// szerokoscMapy;
																										// 2
		// wysokoscMapy; 3
		// ileGraczy; 4 ktoraRunda; 5 ileRund; 6 czas; 7
		// domyslnaSzybkosc; 8 czyHp; 9 kolory; 10 pseudonimy; 11 przenikanie; 12
		// odbijanie;
		...
		rozgrywka = new Rozgrywka(szerokoscMapy, wysokoscMapy, 8, 7, 15, 500, 10, false, kolory, pseudonimy, false, false, mapa);
		ekran.rozgrywka = rozgrywka;
		rozgrywka.petlaGlowna(ekran);
